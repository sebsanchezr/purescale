          ...
          {pains.map((pain, i) => (
            <div key={i} className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-8 hover:border-blue-400/30 transition-all duration-300 flex gap-8 items-start">
              <div className="flex-shrink-0 text-center w-28">
                <div className="whitespace-nowrap text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent leading-none">{pain.stat}</div>
              </div>
              <div>
