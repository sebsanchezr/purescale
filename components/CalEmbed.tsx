...
export function CalEmbed() {
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal.ns["purescale-creative-strategy-call"]("inline", {
        elementOrSelector: "#my-cal-inline-purescale-creative-strategy-call",
        config: {
          layout: "month_view",
      ...
      Cal.ns["purescale-creative-strategy-call"]("on", {
  ...
  return (
    <div
      id="my-cal-inline-purescale-creative-strategy-call"
