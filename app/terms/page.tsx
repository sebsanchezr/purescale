...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" updated="27 July 2026">
      ...
      <p>
        Purchase includes two 1-to-1 strategy calls with our CEO, to be booked within 90
        days of delivery. Unused calls expire after that. Calls are advisory: we review
        your account and creative and tell you what we would do, which is not a guarantee
        of any result.
      </p>
